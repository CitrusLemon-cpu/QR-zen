...
import androidx.lifecycle.Lifecycle; import androidx.lifecycle.lifecycleScope; import androidx.lifecycle.repeatOnLifecycle
import androidx.recyclerview.widget.LinearLayoutManager
import com.qrzen.app.data.model.BlockEvent; import com.qrzen.app.databinding.FragmentStatsBinding
import dagger.hilt.android.AndroidEntryPoint; import kotlinx.coroutines.launch; import java.util.Calendar
...
class StatsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentStatsBinding.inflate(inflater, container, false); return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        adapter = EventAdapter()
        binding.rvEvents.layoutManager = LinearLayoutManager(requireContext()); binding.rvEvents.adapter = adapter
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.recentEvents.collect { events ->
                    updateStats(events); adapter.submitList(events)
