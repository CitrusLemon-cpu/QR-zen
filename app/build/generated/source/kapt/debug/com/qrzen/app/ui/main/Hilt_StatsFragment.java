...
public abstract class Hilt_StatsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StatsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatsFragment_GeneratedInjector) this.generatedComponent()).injectStatsFragment(UnsafeCasts.<StatsFragment>unsafeCast(this));
    }
  }
